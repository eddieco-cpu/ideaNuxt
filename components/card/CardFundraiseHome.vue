<template>
    <div
        class="w-[285px] rounded shadow-card bg-white pb-3 cursor-pointer relative group mx-2 max-md:w-[304px]"
        :class="class"
    >
        <!-- 標籤 -->
        ...
        <article class="w-full px-4 py-3">
            <!-- 文字 -->
            <p
                class="text-sm font-medium mt-3 mb-5 group-hover:text-Primary-600-Dark-Primary transition-text duration-350 ease-in-out"
            >
