<template>
    <div class="fixed top-0 left-0 z-[3] w-screen bg-black/[0.7] h-screen flex items-center justify-center">
        <div
            class="relative w-[375px] h-[79%] rounded-[16px] overflow-hidden"
