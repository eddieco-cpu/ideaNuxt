<template>
    <div
        class="border-[1px] border-Primary-100 rounded-lg px-4 py-3 bg-white ring-1 ring-Primary-100 mb-1"
        :class="class"
    >
        ...
        <p class="flex justify-start items-center gap-x-1 mb-[10px]">
            <b class="text-Status-Color-Danger-500-Primary text-sm font-medium text-xl">NT$ {{ item.specialOffer }}</b>
