<template>
    <div>
        ...
        >
            <!-- 團主排名卡片 -->
            <div
                class="kol-rank px-6 md:w-[1200px] md:gap-y-4 md:mx-auto flex flex-nowrap md:grid md:grid-cols-3 gap-x-3 overflow-x-auto overscroll-x-none transform translate-y-[12.5rem]"
            >
